...
def run_zoneamento(city: str, uf: str, layer_url: str, out_dir: str = "outputs"):
    ...
    geojson_path = os.path.join(out_city, f"zoneamento_{ts}.geojson")
    save_geodata(gdf, geojson_path)
    ...
    if url and not gdf.empty:
        ...
        with eng.begin() as con:
            con.exec_driver_sql(
                "CREATE INDEX IF NOT EXISTS ix_zoneamento_geom ON zoneamento_municipal USING GIST (geom)"
            )
